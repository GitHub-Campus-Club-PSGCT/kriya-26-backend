...
router.get("/algorithmcard", AlgorithmCardController.getCards);
router.get("/algorithmcard/:id", AlgorithmCardController.getCard);
// Round1 routes
...
router.get("/round1/questions", round1questionsController.getRound1Questions);
router.get("/round1/questions/:id", round1questionsController.getRound1Question);
...
router.get("/round2/questions", round2questionsController.getRound2Questions);
router.get("/round2/questions/:id", round2questionsController.getRound2Question);
